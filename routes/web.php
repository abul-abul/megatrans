...
Route::get('useful-information','UsersController@getBlog');
Route::get('inner-blog/{id}','UsersController@getInnerBlog');
Route::get('request','UsersController@getRequest');
Route::post('request','UsersController@postRequest');
